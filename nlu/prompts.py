...
Intents: change_volume, get_weather, send_email, create_event,
music_control, code_action, system_monitor, browser_control, smart_search, other

Rules:
- If user says "open youtube", "open instagram", "open browser", "open amazon", "open flipkart", classify as browser_control.
- If user says "search youtube for ...", classify as smart_search.
- If user says "search amazon for ...", classify as smart_search.
- Do NOT classify these as music_control.


Examples:
"mute" -> {"intent":"change_volume","slots":{"action":"mute"}}
"unmute" -> {"intent":"change_volume","slots":{"action":"unmute"}}
...
"open music" -> {"intent":"music_control","slots":{"action":"open music"}}
"play some music" -> {"intent":"music_control","slots":{"action":"open music"}}
"open songs" -> {"intent":"music_control","slots":{"action":"open music"}}
"close music" -> {"intent":"music_control","slots":{"action":"close"}}
...
"open youtube" -> {"intent":"browser_control","slots":{"site":"youtube"}}
"open browser" -> {"intent":"browser_control","slots":{"site":"google"}}
"open instagram" -> {"intent":"browser_control","slots":{"site":"instagram"}}
"search youtube for python" -> {"intent":"smart_search","slots":{"platform":"youtube","query":"python"}}
"search amazon for laptop" -> {"intent":"smart_search","slots":{"platform":"amazon","query":"laptop"}}

"search youtube for python" -> {"intent":"smart_search","slots":{"platform":"youtube","query":"python"}}
"search amazon for laptop" -> {"intent":"smart_search","slots":{"platform":"amazon","query":"laptop"}}
"search flipkart for mobile" -> {"intent":"smart_search","slots":{"platform":"flipkart","query":"mobile"}}
"search for voice assistant" -> {"intent":"smart_search","slots":{"platform":"google","query":"voice assistant"}}
"search for voice assistant" -> {"intent":"smart_search","slots":{"platform":"wikipedia","query":"voice assistant"}}

"open calculator" -> {"intent":"system_app_control","slots":{"action":"open","app":"calculator"}}
"close calculator" -> {"intent":"system_app_control","slots":{"action":"close","app":"calculator"}}
"open notepad" -> {"intent":"system_app_control","slots":{"action":"open","app":"notepad"}}
"open cmd" -> {"intent":"system_app_control","slots":{"action":"open","app":"cmd"}}
"open camera" -> {"intent":"system_app_control","slots":{"action":"open","app":"camera"}}
"open settings" -> {"intent":"system_app_control","slots":{"action":"open","app":"settings"}}
"open file explorer" -> {"intent":"system_app_control","slots":{"action":"open","app":"explorer"}}
